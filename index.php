      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            ...
            <p>Various luxirous cars for you to choose from </p>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      ...
      <p>This was a personal project & a long time dream to have created a site that excecutes a car rental buisness, MERENT name comes from the fact that it was orignally supposed to be a Merecedes focused car rental website but however we have diversified our reach & outlook</p>
    </div>
    <div class="row"> 
